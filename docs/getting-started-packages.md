...
<img style={{maxWidth: '30rem'}} src="/api/v3/img/images/npm-version-check.png"/>
...
<img style={{maxWidth: '60rem'}} src="/api/v3/img/images/vscode-open-terminal.png"/>
...
<img style={{maxWidth: '60rem'}} src="/api/v3/img/images/npm-init-demo.png"/>
...
<img class="inline-img" style={{maxWidth: '100%'}} src="/api/v3/img/images/python-version-check.png"/>
...
<img class="inline-img" style={{maxWidth: '100%'}} src="/api/v3/img/images/vscode-open-terminal.png"/>
...
<img class="inline-img" style={{maxWidth: '100%'}} src="/api/v3/img/images/vscode-pip-install-skyciv.png"/>
