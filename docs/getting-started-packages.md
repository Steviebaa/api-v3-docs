...
<img style="max-width: 30rem;" src="/api/v3/img/images/npm-version-check.png"/>
...
<img style="max-width: 60rem;" src="/api/v3/img/images/vscode-open-terminal.png"/>
...
<img style="max-width: 60rem;" src="/api/v3/img/images/npm-init-demo.png"/>
...
<img class="inline-img" style="max-width: 100%;" src="/api/v3/img/images/python-version-check.png"/>
...
<img class="inline-img" style="max-width: 100%;" src="/api/v3/img/images/vscode-open-terminal.png"/>
...
<img class="inline-img" style="max-width: 100%;" src="/api/v3/img/images/vscode-pip-install-skyciv.png"/>
